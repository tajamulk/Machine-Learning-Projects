...
Objective of this project is to predict rain in Australia. We have to analyse the historical data and based on that find insights and make predictions effectively.
